  ...
  <template>
    <div class="shop-header">
      <nav class="shop-nav" @click="isShowShopBrief = true"
           :style="{ backgroundImage: `url(${info.bgImg})`}">
        <a class="back" @click="$router.back()">
          <i class="iconfont icon-arrow_left"/>
        </a>
      </nav>
      <div class="shop-content" @click="isShowShopBrief = true">
      ...
      <div class="shop-header-discounts" v-if="info.supports" @click="isShowActivitySheet = true">
        <div class="discounts-left" >
          <div class="activity" :class="colors[info.supports[0].type]">
          <span class="content-tag">
      ...
      <div class="shop-brief-modal" v-show="isShowShopBrief">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="isShowShopBrief = false">
      ...
      <div class="activity-sheet" v-show="isShowActivitySheet">
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">
            优惠活动</h2>
          <ul class="list">
            <li class="activity-item" v-for="(support,index) in info.supports" :key="index" :class="colors[support.type] ">
            <span class="content-tag">
...
<script>
  ...
  export default {
    data () {
      return {
        colors: ['activity-green','activity-red','activity-orange'],
        isShowShopBrief: false,  // false为不显示  true为显示
        isShowActivitySheet: false  //false为不显示  true为显示
      }
    },
    computed: {
      ...mapState(['info'])
